...
public class HandAnimator : MonoBehaviour
{
    ...
    [SerializeField] private InputActionReference controllerActionFist;
    ...
    private readonly List<Finger> fist = new List<Finger>()
    {
        new Finger(FingerType.Thumb),
        new Finger(FingerType.Index),
        new Finger(FingerType.Middle),
...
private void FistAction_performed(InputAction.CallbackContext obj)
{
    SetFingerAnimationValues(fist, 1.0f);
    AnimateActionInput(fist);
}

private void FistAction_canceled(InputAction.CallbackContext obj)
{
    SetFingerAnimationValues(fist, 0.0f);
    AnimateActionInput(fist);
}
